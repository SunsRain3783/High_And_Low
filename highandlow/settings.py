"""
Django settings for highandlow project.
...
SECRET_KEY = '1-5%nm$ap-08f)!boneyv50ow(u$j*xy-_mrx)axgupnvyv-j#'
...
WSGI_APPLICATION = 'highandlow.wsgi.application'
